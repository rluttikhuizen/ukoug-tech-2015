...
public class LifeCycleListenerImpl implements LifeCycleListener, PushNotificationConfig {
    ...
    private static ADFMobileLogger sLog = ADFMobileLogger.createLogger(LifeCycleListenerImpl.class);
    ...
    public void start() {
        ...
        // Add local push notification listener

        EventSource evtSourceLocal =
